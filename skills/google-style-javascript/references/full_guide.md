...
- This Style Guide uses [RFC 2119](http://tools.ietf.org/html/rfc2119) terminology when using the phrases *must*,
...
- Type annotations for primitives (`string`, `number`, `boolean`, `symbol`,
  ...
  string...}}
  ```
  ) are always non-nullable by default. Use the `?` modifier to
