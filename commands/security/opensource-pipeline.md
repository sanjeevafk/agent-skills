...
<!-- Source of truth: skills/opensource-pipeline/SKILL.md -->
---
...
category: "security"
namespace: "/security/opensource-pipeline"
flat_command: "/opensource-pipeline"
---

# Command: opensource-pipeline (/security/opensource-pipeline)

> **Trigger**: Open-source pipeline: fork, sanitize, and package private projects for safe public release. Chains 3 agents (forker, sanitizer, packager). Triggers: '/opensource', 'open source this', 'make this public', 'prepare for open source'.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/opensource-pipeline/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/opensource-pipeline/SKILL.md)
