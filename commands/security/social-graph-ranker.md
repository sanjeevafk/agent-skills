...
<!-- Source of truth: skills/social-graph-ranker/SKILL.md -->
---
...
category: "security"
namespace: "/security/social-graph-ranker"
flat_command: "/social-graph-ranker"
---

# Command: social-graph-ranker (/security/social-graph-ranker)

> **Trigger**: Weighted social-graph ranking for warm intro discovery, bridge scoring, and network gap analysis across X and LinkedIn. Use when the user wants the reusable graph-ranking engine itself, not the broader outreach or network-maintenance workflow layered on top of it.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/social-graph-ranker/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/social-graph-ranker/SKILL.md)
