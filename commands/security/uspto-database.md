...
<!-- Source of truth: skills/scientific-db-uspto-database/SKILL.md -->
---
...
category: "security"
namespace: "/security/uspto-database"
flat_command: "/uspto-database"
---

# Command: uspto-database (/security/uspto-database)

> **Trigger**: USPTO patent and trademark data workflow for official record lookup, PatentSearch queries, TSDR checks, assignment data, and reproducible IP research logs.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/scientific-db-uspto-database/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/scientific-db-uspto-database/SKILL.md)
