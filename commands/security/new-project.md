...
<!-- Source of truth: skills/context-hub-new-project/SKILL.md -->
---
...
category: "security"
namespace: "/security/new-project"
flat_command: "/new-project"
---

# Command: new-project (/security/new-project)

> **Trigger**: Build a new AI agent with Olakai monitoring from scratch — project setup, SDK integration, KPI configuration, and end-to-end validation
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/context-hub-new-project/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/context-hub-new-project/SKILL.md)
