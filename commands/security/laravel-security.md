...
<!-- Source of truth: skills/laravel-security/SKILL.md -->
---
...
category: "security"
namespace: "/security/laravel-security"
flat_command: "/laravel-security"
---

# Command: laravel-security (/security/laravel-security)

> **Trigger**: Laravel security best practices — authentication, authorization, Eloquent safety, CSRF, XSS prevention, API security, and secure deployment configurations.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/laravel-security/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/laravel-security/SKILL.md)
