...
<!-- Source of truth: skills/autonomous-loops/SKILL.md -->
---
description: "Patterns and architectures for autonomous Claude Code loops — from simple sequential pipelines to RFC-driven multi-agent DAG systems."
category: "security"
namespace: "/security/autonomous-loops"
flat_command: "/autonomous-loops"
---

# Command: autonomous-loops (/security/autonomous-loops)

> **Trigger**: Patterns and architectures for autonomous Claude Code loops — from simple sequential pipelines to RFC-driven multi-agent DAG systems.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/autonomous-loops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/autonomous-loops/SKILL.md)
