...
<!-- Source of truth: skills/perl-security/SKILL.md -->
---
...
category: "security"
namespace: "/security/perl-security"
flat_command: "/perl-security"
---

# Command: perl-security (/security/perl-security)

> **Trigger**: Comprehensive Perl security covering taint mode, input validation, safe process execution, DBI parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic security policies.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/perl-security/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/perl-security/SKILL.md)
