...
<!-- Source of truth: skills/ralphinho-rfc-pipeline/SKILL.md -->
---
description: "RFC-driven multi-agent DAG execution pattern with quality gates, merge queues, and work unit orchestration."
category: "security"
namespace: "/security/ralphinho-rfc-pipeline"
flat_command: "/ralphinho-rfc-pipeline"
---

# Command: ralphinho-rfc-pipeline (/security/ralphinho-rfc-pipeline)

> **Trigger**: RFC-driven multi-agent DAG execution pattern with quality gates, merge queues, and work unit orchestration.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/ralphinho-rfc-pipeline/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ralphinho-rfc-pipeline/SKILL.md)
