...
<!-- Source of truth: skills/llm-trading-agent-security/SKILL.md -->
---
...
category: "security"
namespace: "/security/llm-trading-agent-security"
flat_command: "/llm-trading-agent-security"
---

# Command: llm-trading-agent-security (/security/llm-trading-agent-security)

> **Trigger**: Security patterns for autonomous trading agents with wallet or transaction authority. Covers prompt injection, spend limits, pre-send simulation, circuit breakers, MEV protection, and key handling.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/llm-trading-agent-security/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/llm-trading-agent-security/SKILL.md)
