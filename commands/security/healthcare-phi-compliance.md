...
<!-- Source of truth: skills/healthcare-phi-compliance/SKILL.md -->
---
...
category: "security"
namespace: "/security/healthcare-phi-compliance"
flat_command: "/healthcare-phi-compliance"
---

# Command: healthcare-phi-compliance (/security/healthcare-phi-compliance)

> **Trigger**: Protected Health Information (PHI) and Personally Identifiable Information (PII) compliance patterns for healthcare applications. Covers data classification, access control, audit trails, encryption, and common leak vectors.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/healthcare-phi-compliance/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/healthcare-phi-compliance/SKILL.md)
