...
<!-- Source of truth: skills/healthcare-eval-harness/SKILL.md -->
---
...
category: "security"
namespace: "/security/healthcare-eval-harness"
flat_command: "/healthcare-eval-harness"
---

# Command: healthcare-eval-harness (/security/healthcare-eval-harness)

> **Trigger**: Patient safety evaluation harness for healthcare application deployments. Automated test suites for CDSS accuracy, PHI exposure, clinical workflow integrity, and integration compliance. Blocks deployments on safety failures.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/healthcare-eval-harness/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/healthcare-eval-harness/SKILL.md)
