...
<!-- Source of truth: skills/x-api/SKILL.md -->
---
description: "X/Twitter API integration for posting tweets, threads, reading timelines, search, and analytics. Covers OAuth auth patterns, rate limits, and platform-native content posting. Use when the user wants to interact with X programmatically."
category: "security"
namespace: "/security/x-api"
flat_command: "/x-api"
---

# Command: x-api (/security/x-api)

> **Trigger**: X/Twitter API integration for posting tweets, threads, reading timelines, search, and analytics. Covers OAuth auth patterns, rate limits, and platform-native content posting. Use when the user wants to interact with X programmatically.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/x-api/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/x-api/SKILL.md)
