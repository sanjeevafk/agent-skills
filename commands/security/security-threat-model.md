...
<!-- Source of truth: skills/security-threat-model/SKILL.md -->
---
description: "Repository-grounded threat modeling that enumerates trust boundaries, assets, attacker capabilities, abuse paths, and mitigations, and writes a concise Markdown threat model. Trigger only when the user explicitly asks to threat model a codebase or path, enumerate threats/abuse paths, or perform AppSec threat modeling. Do not trigger for general architecture summaries, code review, or non-security design work."
category: "security"
namespace: "/security/security-threat-model"
flat_command: "/security-threat-model"
---

# Command: security-threat-model (/security/security-threat-model)

> **Trigger**: Repository-grounded threat modeling that enumerates trust boundaries, assets, attacker capabilities, abuse paths, and mitigations, and writes a concise Markdown threat model. Trigger only when the user explicitly asks to threat model a codebase or path, enumerate threats/abuse paths, or perform AppSec threat modeling. Do not trigger for general architecture summaries, code review, or non-security design work.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/security-threat-model/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/security-threat-model/SKILL.md)
