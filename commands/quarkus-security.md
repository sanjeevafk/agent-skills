...
<!-- Source of truth: skills/quarkus-security/SKILL.md -->
---
...
category: "security"
namespace: "/security/quarkus-security"
flat_command: "/quarkus-security"
---

# Command: quarkus-security (/security/quarkus-security)

> **Trigger**: Quarkus Security best practices for authentication, authorization, JWT/OIDC, RBAC, input validation, CSRF, secrets management, and dependency security.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/quarkus-security/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/quarkus-security/SKILL.md)
