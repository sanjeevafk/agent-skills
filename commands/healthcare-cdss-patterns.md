...
<!-- Source of truth: skills/healthcare-cdss-patterns/SKILL.md -->
---
...
category: "web"
namespace: "/web/healthcare-cdss-patterns"
flat_command: "/healthcare-cdss-patterns"
---

# Command: healthcare-cdss-patterns (/web/healthcare-cdss-patterns)

> **Trigger**: Clinical Decision Support System (CDSS) development patterns. Drug interaction checking, dose validation, clinical scoring (NEWS2, qSOFA), alert severity classification, and integration into EMR workflows.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/healthcare-cdss-patterns/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/healthcare-cdss-patterns/SKILL.md)
