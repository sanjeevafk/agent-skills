...
<!-- Source of truth: skills/hermes-imports/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/hermes-imports"
flat_command: "/hermes-imports"
---

# Command: hermes-imports (/workflow/hermes-imports)

> **Trigger**: Convert local Hermes operator workflows into sanitized ECC skills and release-pack artifacts. Use when preparing a Hermes workflow for public ECC reuse without leaking private workspace state, credentials, or local-only paths.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/hermes-imports/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/hermes-imports/SKILL.md)
