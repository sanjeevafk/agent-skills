...
<!-- Source of truth: skills/blender-motion-state-inspection/SKILL.md -->
---
...
category: "devops"
namespace: "/devops/blender-motion-state-inspection"
flat_command: "/blender-motion-state-inspection"
---

# Command: blender-motion-state-inspection (/devops/blender-motion-state-inspection)

> **Trigger**: Use this skill when inspecting Blender characters, rigs, poses, animation retargeting, ground contact, facing direction, or model-vs-motion alignment where screenshots alone are not enough.
> **Category**: DevOps, CI/CD & Deployment
> **Source Skill**: [skills/blender-motion-state-inspection/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/blender-motion-state-inspection/SKILL.md)
