...
<!-- Source of truth: skills/triage-issue/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/triage-issue"
flat_command: "/triage-issue"
---

# Command: triage-issue (/debug/triage-issue)

> **Trigger**: Triage a bug or issue by exploring the codebase to find root cause, then create a GitHub issue with a TDD-based fix plan. Use when user reports a bug, wants to file an issue, mentions \"triage\", or wants to investigate and plan a fix for a problem.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/triage-issue/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/triage-issue/SKILL.md)
