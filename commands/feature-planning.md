...
<!-- Source of truth: skills/feature-planning/SKILL.md -->
---
...
category: "security"
namespace: "/security/feature-planning"
flat_command: "/feature-planning"
---

# Command: feature-planning (/security/feature-planning)

> **Trigger**: Break down feature requests into detailed, implementable plans with clear tasks. Use when user requests a new feature, enhancement, or complex change.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/feature-planning/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/feature-planning/SKILL.md)
