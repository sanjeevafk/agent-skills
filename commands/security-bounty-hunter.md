...
<!-- Source of truth: skills/security-bounty-hunter/SKILL.md -->
---
...
category: "security"
namespace: "/security/security-bounty-hunter"
flat_command: "/security-bounty-hunter"
---

# Command: security-bounty-hunter (/security/security-bounty-hunter)

> **Trigger**: Hunt for exploitable, bounty-worthy security issues in repositories. Focuses on remotely reachable vulnerabilities that qualify for real reports instead of noisy local-only findings.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/security-bounty-hunter/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/security-bounty-hunter/SKILL.md)
