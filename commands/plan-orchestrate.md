...
<!-- Source of truth: skills/plan-orchestrate/SKILL.md -->
---
description: "Read a plan document, decompose it into steps, design a per-step agent chain from the ECC catalogue, and emit ready-to-paste /orchestrate custom prompts. Generative only — never invokes /orchestrate itself. Use when the user has a multi-step plan and wants to drive it through orchestrate without composing chains by hand."
category: "ai-ml"
namespace: "/ai-ml/plan-orchestrate"
flat_command: "/plan-orchestrate"
---

# Command: plan-orchestrate (/ai-ml/plan-orchestrate)

> **Trigger**: Read a plan document, decompose it into steps, design a per-step agent chain from the ECC catalogue, and emit ready-to-paste /orchestrate custom prompts. Generative only — never invokes /orchestrate itself. Use when the user has a multi-step plan and wants to drive it through orchestrate without composing chains by hand.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/plan-orchestrate/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/plan-orchestrate/SKILL.md)
