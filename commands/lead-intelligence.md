...
<!-- Source of truth: skills/lead-intelligence/SKILL.md -->
---
description: "AI-native lead intelligence and outreach pipeline. Replaces Apollo, Clay, and ZoomInfo with agent-powered signal scoring, mutual ranking, warm path discovery, source-derived voice modeling, and channel-specific outreach across email, LinkedIn, and X. Use when the user wants to find, qualify, and reach high-value contacts."
category: "web"
namespace: "/web/lead-intelligence"
flat_command: "/lead-intelligence"
---

# Command: lead-intelligence (/web/lead-intelligence)

> **Trigger**: AI-native lead intelligence and outreach pipeline. Replaces Apollo, Clay, and ZoomInfo with agent-powered signal scoring, mutual ranking, warm path discovery, source-derived voice modeling, and channel-specific outreach across email, LinkedIn, and X. Use when the user wants to find, qualify, and reach high-value contacts.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/lead-intelligence/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/lead-intelligence/SKILL.md)
