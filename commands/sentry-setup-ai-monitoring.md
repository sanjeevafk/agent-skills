...
<!-- Source of truth: skills/sentry-setup-ai-monitoring/SKILL.md -->
---
...
namespace: "/feature-setup/setup-ai-monitoring"
flat_command: "/sentry-setup-ai-monitoring"
---

# Command: sentry-setup-ai-monitoring (/feature-setup/setup-ai-monitoring)

> **Trigger**: Setup Sentry AI Agent Monitoring in any project. Use when asked to monitor LLM calls, track AI agents, or instrument OpenAI/Anthropic/Vercel AI/LangChain/Google GenAI/Pydantic AI. Detects installed AI SDKs and configures appropriate integrations.
> **Category**: Feature-Setup
> **Source Skill**: [skills/sentry-setup-ai-monitoring/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-setup-ai-monitoring/SKILL.md)
