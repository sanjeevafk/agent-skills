...
<!-- Source of truth: skills/yeet/SKILL.md -->
---
description: "Use only when the user explicitly asks to stage, commit, push, and open a GitHub pull request in one flow using the GitHub CLI (`gh`)."
category: "security"
namespace: "/security/yeet"
flat_command: "/yeet"
---

# Command: yeet (/security/yeet)

> **Trigger**: Use only when the user explicitly asks to stage, commit, push, and open a GitHub pull request in one flow using the GitHub CLI (`gh`).
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/yeet/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/yeet/SKILL.md)
