...
<!-- Source of truth: skills/claude-devfleet/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/claude-devfleet"
flat_command: "/claude-devfleet"
---

# Command: claude-devfleet (/ai-ml/claude-devfleet)

> **Trigger**: Orchestrate multi-agent coding tasks via Claude DevFleet — plan projects, dispatch parallel agents in isolated worktrees, monitor progress, and read structured reports.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/claude-devfleet/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/claude-devfleet/SKILL.md)
