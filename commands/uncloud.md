...
<!-- Source of truth: skills/uncloud/SKILL.md -->
---
...
category: "devops"
namespace: "/devops/uncloud"
flat_command: "/uncloud"
---

# Command: uncloud (/devops/uncloud)

> **Trigger**: Use when managing an Uncloud cluster — deploying services, configuring Caddy ingress, adding static proxy routes for non-cluster devices, publishing ports, scaling, inspecting logs, or managing machines and volumes with the `uc` CLI.
> **Category**: DevOps, CI/CD & Deployment
> **Source Skill**: [skills/uncloud/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/uncloud/SKILL.md)
