...
<!-- Source of truth: skills/context-hub-login-flows/SKILL.md -->
---
description: "Common login automation patterns for web apps using Playwright"
category: "lang"
namespace: "/lang/login-flows"
flat_command: "/login-flows"
---

# Command: login-flows (/lang/login-flows)

> **Trigger**: Common login automation patterns for web apps using Playwright
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/context-hub-login-flows/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/context-hub-login-flows/SKILL.md)
