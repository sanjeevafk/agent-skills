...
<!-- Source of truth: skills/benchmark-optimization-loop/SKILL.md -->
---
...
category: "web"
namespace: "/web/benchmark-optimization-loop"
flat_command: "/benchmark-optimization-loop"
---

# Command: benchmark-optimization-loop (/web/benchmark-optimization-loop)

> **Trigger**: Use when the user asks to make something faster, try many variants, run recursive optimization, benchmark latency/throughput/cost, or choose the best implementation by repeated measured tests.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/benchmark-optimization-loop/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/benchmark-optimization-loop/SKILL.md)
