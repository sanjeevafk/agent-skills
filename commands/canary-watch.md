...
<!-- Source of truth: skills/canary-watch/SKILL.md -->
---
...
category: "devops"
namespace: "/devops/canary-watch"
flat_command: "/canary-watch"
---

# Command: canary-watch (/devops/canary-watch)

> **Trigger**: Use this skill to monitor and verify a deployed URL after releases — checks HTTP endpoints, SSE streams, static assets, console errors, and performance regressions after deploys, merges, or dependency upgrades. Smoke / canary / post-deploy verification.
> **Category**: DevOps, CI/CD & Deployment
> **Source Skill**: [skills/canary-watch/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/canary-watch/SKILL.md)
