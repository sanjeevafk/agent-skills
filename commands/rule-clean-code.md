...
<!-- Source of truth: rules/agent-rules-books/clean-code.md -->
---
description: "Rule: clean-code"
category: "rule"
namespace: "/rule/clean-code"
flat_command: "/rule-clean-code"
---

# Rule Command: /rule/clean-code

> **Source Rule File**: [rules/agent-rules-books/clean-code.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/clean-code.md)
