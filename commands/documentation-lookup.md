...
<!-- Source of truth: skills/documentation-lookup/SKILL.md -->
---
description: "Use up-to-date library and framework docs via Context7 MCP instead of training data. Activates for setup questions, API references, code examples, or when the user names a framework (e.g. React, Next.js, Prisma)."
category: "web"
namespace: "/web/documentation-lookup"
flat_command: "/documentation-lookup"
---

# Command: documentation-lookup (/web/documentation-lookup)

> **Trigger**: Use up-to-date library and framework docs via Context7 MCP instead of training data. Activates for setup questions, API references, code examples, or when the user names a framework (e.g. React, Next.js, Prisma).
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/documentation-lookup/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/documentation-lookup/SKILL.md)
