...
<!-- Source of truth: skills/unified-memory/SKILL.md -->
---
...
category: "web"
namespace: "/web/unified-memory"
flat_command: "/unified-memory"
---

# Command: unified-memory (/web/unified-memory)

> **Trigger**: Share durable, inspectable context and handoffs between Claude, Codex, Hermes, Cursor, OpenCode, and other agents through the local ECC Memory Vault. Use when an agent must save work state, transfer context, resume another agent's task, or search shared project knowledge.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/unified-memory/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/unified-memory/SKILL.md)
