...
<!-- Source of truth: skills/swift-actor-persistence/SKILL.md -->
---
description: "Thread-safe data persistence in Swift using actors — in-memory cache with file-backed storage, eliminating data races by design."
category: "web"
namespace: "/web/swift-actor-persistence"
flat_command: "/swift-actor-persistence"
---

# Command: swift-actor-persistence (/web/swift-actor-persistence)

> **Trigger**: Thread-safe data persistence in Swift using actors — in-memory cache with file-backed storage, eliminating data races by design.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/swift-actor-persistence/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/swift-actor-persistence/SKILL.md)
