...
<!-- Source of truth: skills/config-gc/SKILL.md -->
---
...
category: "web"
namespace: "/web/config-gc"
flat_command: "/config-gc"
---

# Command: config-gc (/web/config-gc)

> **Trigger**: Garbage collection for your Claude Code configuration. Periodically scans ~/.claude (skills, memory, hooks, permissions, MCP servers, caches) for redundant, stale, orphaned, or low-value items, then walks the user through a confirm-each-deletion cleanup. Use when the user says \"clean up my config\", \"config GC\", \"too many skills\", \"audit my setup\", \"my .claude is bloated\", or asks for a periodic config review.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/config-gc/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/config-gc/SKILL.md)
