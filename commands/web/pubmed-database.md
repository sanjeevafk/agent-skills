...
<!-- Source of truth: skills/scientific-db-pubmed-database/SKILL.md -->
---
...
category: "web"
namespace: "/web/pubmed-database"
flat_command: "/pubmed-database"
---

# Command: pubmed-database (/web/pubmed-database)

> **Trigger**: Direct PubMed and NCBI E-utilities search workflows for biomedical literature, MeSH queries, PMID lookup, citation retrieval, and API-backed literature monitoring.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/scientific-db-pubmed-database/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/scientific-db-pubmed-database/SKILL.md)
