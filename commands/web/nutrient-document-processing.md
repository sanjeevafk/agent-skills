...
<!-- Source of truth: skills/nutrient-document-processing/SKILL.md -->
---
...
category: "web"
namespace: "/web/nutrient-document-processing"
flat_command: "/nutrient-document-processing"
---

# Command: nutrient-document-processing (/web/nutrient-document-processing)

> **Trigger**: Process, convert, OCR, extract, redact, sign, and fill documents using the Nutrient DWS API. Works with PDFs, DOCX, XLSX, PPTX, HTML, and images.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/nutrient-document-processing/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/nutrient-document-processing/SKILL.md)
