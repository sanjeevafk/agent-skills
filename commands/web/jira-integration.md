...
<!-- Source of truth: skills/jira-integration/SKILL.md -->
---
...
category: "web"
namespace: "/web/jira-integration"
flat_command: "/jira-integration"
---

# Command: jira-integration (/web/jira-integration)

> **Trigger**: Use this skill when retrieving Jira tickets, analyzing requirements, updating ticket status, adding comments, or transitioning issues. Provides Jira API patterns via MCP or direct REST calls.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/jira-integration/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/jira-integration/SKILL.md)
