...
<!-- Source of truth: skills/brain-to-docs/SKILL.md -->
---
...
category: "web"
namespace: "/web/brain-to-docs"
flat_command: "/brain-to-docs"
---

# Command: brain-to-docs (/web/brain-to-docs)

> **Trigger**: Use when the user wants to extract project vision, decisions, and preferences from his head into clear documentation (README + ADRs) through a back-and-forth Q&A loop. Triggers on \"brain-to-docs\", \"build out the docs\", \"extract the vision\", \"let's document this project\".
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/brain-to-docs/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/brain-to-docs/SKILL.md)
