...
<!-- Source of truth: skills/error-handling/SKILL.md -->
---
...
category: "web"
namespace: "/web/error-handling"
flat_command: "/error-handling"
---

# Command: error-handling (/web/error-handling)

> **Trigger**: Patterns for robust error handling across TypeScript, Python, and Go. Covers typed errors, error boundaries, retries, circuit breakers, and user-facing error messages.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/error-handling/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/error-handling/SKILL.md)
