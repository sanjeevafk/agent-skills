...
<!-- Source of truth: skills/skill-scout/SKILL.md -->
---
...
category: "web"
namespace: "/web/skill-scout"
flat_command: "/skill-scout"
---

# Command: skill-scout (/web/skill-scout)

> **Trigger**: Search existing local, marketplace, GitHub, and web skill sources before creating a new skill. Use when the user wants to create, build, fork, or find a skill for a workflow.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/skill-scout/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/skill-scout/SKILL.md)
