...
<!-- Source of truth: skills/ito-trade-planner/SKILL.md -->
---
...
category: "web"
namespace: "/web/ito-trade-planner"
flat_command: "/ito-trade-planner"
---

# Command: ito-trade-planner (/web/ito-trade-planner)

> **Trigger**: Build a non-advisory prediction-market trade planning worksheet for Itô or venue workflows. Use to inspect venues, underliers, constraints, order prerequisites, and manual execution steps without placing trades or recommending positions.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/ito-trade-planner/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ito-trade-planner/SKILL.md)
