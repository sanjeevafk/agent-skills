...
<!-- Source of truth: skills/parallel-execution-optimizer/SKILL.md -->
---
...
category: "web"
namespace: "/web/parallel-execution-optimizer"
flat_command: "/parallel-execution-optimizer"
---

# Command: parallel-execution-optimizer (/web/parallel-execution-optimizer)

> **Trigger**: Use when the user wants a task done much faster through parallel work, concurrent agents, batched tool calls, isolated worktrees, or many independent verification lanes without losing correctness.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/parallel-execution-optimizer/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/parallel-execution-optimizer/SKILL.md)
