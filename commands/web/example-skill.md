...
<!-- Source of truth: skills/example-skill/SKILL.md -->
---
...
category: "web"
namespace: "/web/example-skill"
flat_command: "/example-skill"
---

# Command: example-skill (/web/example-skill)

> **Trigger**: This skill should be used when the user asks to \"demonstrate skills\", \"show skill format\", \"create a skill template\", or discusses skill development patterns. Provides a reference template for creating Claude Code plugin skills.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/example-skill/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/example-skill/SKILL.md)
