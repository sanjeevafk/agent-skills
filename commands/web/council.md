...
<!-- Source of truth: skills/council/SKILL.md -->
---
...
category: "web"
namespace: "/web/council"
flat_command: "/council"
---

# Command: council (/web/council)

> **Trigger**: Convene a four-voice council for ambiguous decisions, tradeoffs, and go/no-go calls. Use when multiple valid paths exist and you need structured disagreement before choosing.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/council/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/council/SKILL.md)
