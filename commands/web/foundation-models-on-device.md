...
<!-- Source of truth: skills/foundation-models-on-device/SKILL.md -->
---
...
category: "web"
namespace: "/web/foundation-models-on-device"
flat_command: "/foundation-models-on-device"
---

# Command: foundation-models-on-device (/web/foundation-models-on-device)

> **Trigger**: Apple FoundationModels framework for on-device LLM — text generation, guided generation with @Generable, tool calling, and snapshot streaming in iOS 26+.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/foundation-models-on-device/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/foundation-models-on-device/SKILL.md)
