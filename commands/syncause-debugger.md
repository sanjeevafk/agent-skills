...
<!-- Source of truth: skills/syncause-debugger/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/syncause-debugger"
flat_command: "/syncause-debugger"
---

# Command: syncause-debugger (/debug/syncause-debugger)

> **Trigger**: Diagnose and fix bugs using runtime execution traces. Use when debugging errors, analyzing failures, or finding root causes in Python, Node.js, or Java applications.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/syncause-debugger/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/syncause-debugger/SKILL.md)
