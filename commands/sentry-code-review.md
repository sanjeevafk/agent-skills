...
<!-- Source of truth: skills/sentry-code-review/SKILL.md -->
---
...
flat_command: "/sentry-code-review"
---

# Command: sentry-code-review (/workflow/code-review)

> **Trigger**: Analyze and resolve Sentry comments on GitHub Pull Requests. Use this when asked to review or fix issues identified by Sentry in PR comments. Can review specific PRs by number or automatically find recent PRs with Sentry feedback.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/sentry-code-review/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-code-review/SKILL.md)
