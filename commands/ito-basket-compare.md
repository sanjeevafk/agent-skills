...
<!-- Source of truth: skills/ito-basket-compare/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/ito-basket-compare"
flat_command: "/ito-basket-compare"
---

# Command: ito-basket-compare (/workflow/ito-basket-compare)

> **Trigger**: Compare Itô prediction-market baskets against a user's knowledge base, portfolio notes, financial context, watchlist, or research thesis. Use for read-only basket comparison and gap analysis without investment advice or live trading.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/ito-basket-compare/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ito-basket-compare/SKILL.md)
