...
<!-- Source of truth: skills/context-hub-integrate/SKILL.md -->
---
...
category: "web"
namespace: "/web/integrate"
flat_command: "/integrate"
---

# Command: integrate (/web/integrate)

> **Trigger**: Add Olakai monitoring to existing AI code — wrap your LLM client, configure custom KPIs, and validate the integration end-to-end
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/context-hub-integrate/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/context-hub-integrate/SKILL.md)
