...
<!-- Source of truth: skills/interview-style-doc-building/SKILL.md -->
---
...
category: "style"
namespace: "/style/interview-style-doc-building"
flat_command: "/interview-style-doc-building"
---

# Command: interview-style-doc-building (/style/interview-style-doc-building)

> **Trigger**: Use when the user wants to build a structured strategic document by answering questions (life priorities, goals docs, framework files, ranked lists, principles, reviews). Interview one question at a time, patch the file after each answer, then re-ask. Not for day planning (use day-plan).
> **Category**: Coding Style & Architecture Standards
> **Source Skill**: [skills/interview-style-doc-building/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/interview-style-doc-building/SKILL.md)
