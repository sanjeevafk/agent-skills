...
<!-- Source of truth: skills/production-audit/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/production-audit"
flat_command: "/production-audit"
---

# Command: production-audit (/workflow/production-audit)

> **Trigger**: Local-evidence production readiness audit for shipped apps, pre-launch reviews, post-merge checks, and \"what breaks in prod?\" questions without sending repo data to an external audit service.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/production-audit/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/production-audit/SKILL.md)
