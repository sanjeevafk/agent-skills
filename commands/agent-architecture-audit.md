...
<!-- Source of truth: skills/agent-architecture-audit/SKILL.md -->
---
description: "Full-stack diagnostic for agent and LLM applications. Audits the 12-layer agent stack for wrapper regression, memory pollution, tool discipline failures, hidden repair loops, and rendering corruption. Produces severity-ranked findings with code-first fixes. Essential for developers building agent applications, autonomous loops, or any LLM-powered feature."
category: "web"
namespace: "/web/agent-architecture-audit"
flat_command: "/agent-architecture-audit"
---

# Command: agent-architecture-audit (/web/agent-architecture-audit)

> **Trigger**: Full-stack diagnostic for agent and LLM applications. Audits the 12-layer agent stack for wrapper regression, memory pollution, tool discipline failures, hidden repair loops, and rendering corruption. Produces severity-ranked findings with code-first fixes. Essential for developers building agent applications, autonomous loops, or any LLM-powered feature.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/agent-architecture-audit/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/agent-architecture-audit/SKILL.md)
