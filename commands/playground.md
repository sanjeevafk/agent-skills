...
<!-- Source of truth: skills/playground/SKILL.md -->
---
...
flat_command: "/playground"
---

# Command: playground (/web/playground)

> **Trigger**: Creates interactive HTML playgrounds — self-contained single-file explorers that let users configure something visually through controls, see a live preview, and copy out a prompt. Use when the user asks to make a playground, explorer, or interactive tool for a topic.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/playground/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/playground/SKILL.md)
