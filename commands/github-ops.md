...
<!-- Source of truth: skills/github-ops/SKILL.md -->
---
description: "GitHub repository operations, automation, and management. Issue triage, PR management, CI/CD operations, release management, and security monitoring using the gh CLI. Use when the user wants to manage GitHub issues, PRs, CI status, releases, contributors, stale items, or any GitHub operational task beyond simple git commands."
category: "debug"
namespace: "/debug/github-ops"
flat_command: "/github-ops"
---

# Command: github-ops (/debug/github-ops)

> **Trigger**: GitHub repository operations, automation, and management. Issue triage, PR management, CI/CD operations, release management, and security monitoring using the gh CLI. Use when the user wants to manage GitHub issues, PRs, CI status, releases, contributors, stale items, or any GitHub operational task beyond simple git commands.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/github-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/github-ops/SKILL.md)
