...
<!-- Source of truth: skills/agentic-os/SKILL.md -->
---
...
category: "web"
namespace: "/web/agentic-os"
flat_command: "/agentic-os"
---

# Command: agentic-os (/web/agentic-os)

> **Trigger**: Build persistent multi-agent operating systems on Claude Code. Covers kernel architecture, specialist agents, slash commands, file-based memory, scheduled automation, and state management without external databases.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/agentic-os/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/agentic-os/SKILL.md)
