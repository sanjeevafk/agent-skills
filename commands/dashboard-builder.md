...
<!-- Source of truth: skills/dashboard-builder/SKILL.md -->
---
...
flat_command: "/dashboard-builder"
---

# Command: dashboard-builder (/web/dashboard-builder)

> **Trigger**: Build monitoring dashboards that answer real operator questions for Grafana, SigNoz, and similar platforms. Use when turning metrics into a working dashboard instead of a vanity board.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/dashboard-builder/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/dashboard-builder/SKILL.md)
