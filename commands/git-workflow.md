...
<!-- Source of truth: skills/git-workflow/SKILL.md -->
---
description: "Git workflow patterns including branching strategies, commit conventions, merge vs rebase, conflict resolution, and collaborative development best practices for teams of all sizes."
category: "workflow"
namespace: "/workflow/git-workflow"
flat_command: "/git-workflow"
---

# Command: git-workflow (/workflow/git-workflow)
...
> **Source Skill**: [skills/git-workflow/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/git-workflow/SKILL.md)
