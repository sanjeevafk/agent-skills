...
<!-- Source of truth: skills/email-ops/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/email-ops"
flat_command: "/email-ops"
---

# Command: email-ops (/debug/email-ops)

> **Trigger**: Evidence-first mailbox triage, drafting, send verification, and sent-mail-safe follow-up workflow for ECC. Use when the user wants to organize email, draft or send through the real mail surface, or prove what landed in Sent.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/email-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/email-ops/SKILL.md)
