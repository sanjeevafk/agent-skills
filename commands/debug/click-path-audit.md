...
<!-- Source of truth: skills/click-path-audit/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/click-path-audit"
flat_command: "/click-path-audit"
---

# Command: click-path-audit (/debug/click-path-audit)

> **Trigger**: Trace every user-facing button/touchpoint through its full state change sequence to find bugs where functions individually work but cancel each other out, produce wrong final state, or leave the UI in an inconsistent state. Use when: systematic debugging found no bugs but users report broken buttons, or after any major refactor touching shared state stores.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/click-path-audit/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/click-path-audit/SKILL.md)
