...
<!-- Source of truth: skills/terminal-ops/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/terminal-ops"
flat_command: "/terminal-ops"
---

# Command: terminal-ops (/debug/terminal-ops)

> **Trigger**: Evidence-first repo execution workflow for ECC. Use when the user wants a command run, a repo checked, a CI failure debugged, or a narrow fix pushed with exact proof of what was executed and verified.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/terminal-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/terminal-ops/SKILL.md)
