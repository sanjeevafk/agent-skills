...
<!-- Source of truth: skills/kubernetes-patterns/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/kubernetes-patterns"
flat_command: "/kubernetes-patterns"
---

# Command: kubernetes-patterns (/debug/kubernetes-patterns)

> **Trigger**: Kubernetes workload patterns, resource management, RBAC, probes, autoscaling, ConfigMap/Secret handling, and kubectl debugging for production-grade deployments.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/kubernetes-patterns/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/kubernetes-patterns/SKILL.md)
