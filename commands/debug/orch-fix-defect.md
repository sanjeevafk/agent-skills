...
<!-- Source of truth: skills/orch-fix-defect/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/orch-fix-defect"
flat_command: "/orch-fix-defect"
---

# Command: orch-fix-defect (/debug/orch-fix-defect)

> **Trigger**: Orchestrate fixing a bug — reproduce it as a failing regression test, fix to green, review, and gated commit — by delegating each phase to the matching ECC agent. Use when existing behavior is broken or wrong.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/orch-fix-defect/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/orch-fix-defect/SKILL.md)
