...
<!-- Source of truth: skills/playwright-interactive/SKILL.md -->
---
description: "Persistent browser and Electron interaction through `js_repl` for fast iterative UI debugging."
category: "debug"
namespace: "/debug/playwright-interactive"
flat_command: "/playwright-interactive"
---

# Command: playwright-interactive (/debug/playwright-interactive)

> **Trigger**: Persistent browser and Electron interaction through `js_repl` for fast iterative UI debugging.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/playwright-interactive/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/playwright-interactive/SKILL.md)
