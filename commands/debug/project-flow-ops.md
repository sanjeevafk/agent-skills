...
<!-- Source of truth: skills/project-flow-ops/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/project-flow-ops"
flat_command: "/project-flow-ops"
---

# Command: project-flow-ops (/debug/project-flow-ops)

> **Trigger**: Operate execution flow across GitHub and Linear by triaging issues and pull requests, linking active work, and keeping GitHub public-facing while Linear remains the internal execution layer. Use when the user wants backlog control, PR triage, or GitHub-to-Linear coordination.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/project-flow-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/project-flow-ops/SKILL.md)
