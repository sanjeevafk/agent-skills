...
<!-- Source of truth: skills/network-interface-health/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/network-interface-health"
flat_command: "/network-interface-health"
---

# Command: network-interface-health (/debug/network-interface-health)
...
> **Source Skill**: [skills/network-interface-health/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/network-interface-health/SKILL.md)
