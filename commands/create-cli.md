...
<!-- Source of truth: skills/create-cli/SKILL.md -->
---
description: "CLI UX/spec: args, flags, help, output, errors, config, dry-run."
category: "web"
namespace: "/web/create-cli"
flat_command: "/create-cli"
---

# Command: create-cli (/web/create-cli)

> **Trigger**: CLI UX/spec: args, flags, help, output, errors, config, dry-run.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/create-cli/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/create-cli/SKILL.md)
