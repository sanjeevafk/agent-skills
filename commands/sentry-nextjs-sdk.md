...
<!-- Source of truth: skills/sentry-nextjs-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/nextjs-sdk"
flat_command: "/sentry-nextjs-sdk"
---

# Command: sentry-nextjs-sdk (/sdk-setup/nextjs-sdk)

> **Trigger**: Full Sentry SDK setup for Next.js. Use when asked to \"add Sentry to Next.js\", \"install @sentry/nextjs\", or configure error monitoring, tracing, session replay, logging, profiling, AI monitoring, or crons for Next.js applications. Supports Next.js 13+ with App Router and Pages Router.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-nextjs-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-nextjs-sdk/SKILL.md)
