...
<!-- Source of truth: rules/agent-rules-books/patterns-of-enterprise-application-architecture.md -->
---
description: "Rule: patterns-of-enterprise-application-architecture"
category: "rule"
namespace: "/rule/patterns-of-enterprise-application-architecture"
flat_command: "/rule-patterns-of-enterprise-application-architecture"
---

# Rule Command: /rule/patterns-of-enterprise-application-architecture

> **Source Rule File**: [rules/agent-rules-books/patterns-of-enterprise-application-architecture.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/patterns-of-enterprise-application-architecture.md)
