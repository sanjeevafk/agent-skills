...
<!-- Source of truth: skills/codebase-onboarding/SKILL.md -->
---
...
category: "web"
namespace: "/web/codebase-onboarding"
flat_command: "/codebase-onboarding"
---

# Command: codebase-onboarding (/web/codebase-onboarding)

> **Trigger**: Analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, and a starter CLAUDE.md. Use when joining a new project or setting up Claude Code for the first time in a repo.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/codebase-onboarding/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/codebase-onboarding/SKILL.md)
