...
<!-- Source of truth: skills/marketing-campaign/SKILL.md -->
---
...
category: "web"
namespace: "/web/marketing-campaign"
flat_command: "/marketing-campaign"
---

# Command: marketing-campaign (/web/marketing-campaign)

> **Trigger**: End-to-end marketing campaign planning and execution. Covers audience research, positioning, campaign angle definition, landing page copy, email sequences, social posts, ad copy, short-form video scripts, and content calendars. Use as the orchestration layer for multi-channel product launches.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/marketing-campaign/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/marketing-campaign/SKILL.md)
