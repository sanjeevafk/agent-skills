...
<!-- Source of truth: skills/sentry-create-alert/SKILL.md -->
---
...
namespace: "/feature-setup/create-alert"
flat_command: "/sentry-create-alert"
---

# Command: sentry-create-alert (/feature-setup/create-alert)

> **Trigger**: Create Sentry alerts using the workflow engine API. Use when asked to create alerts, set up notifications, configure issue priority alerts, or build workflow automations. Supports email, Slack, PagerDuty, Discord, and other notification actions.
> **Category**: Feature-Setup
> **Source Skill**: [skills/sentry-create-alert/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-create-alert/SKILL.md)
