...
<!-- Source of truth: skills/ci-cd-pipeline-builder/SKILL.md -->
---
description: "CI/CD Pipeline Builder"
category: "web"
namespace: "/web/ci-cd-pipeline-builder"
flat_command: "/ci-cd-pipeline-builder"
---

# Command: ci-cd-pipeline-builder (/web/ci-cd-pipeline-builder)

> **Trigger**: CI/CD Pipeline Builder
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/ci-cd-pipeline-builder/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ci-cd-pipeline-builder/SKILL.md)
