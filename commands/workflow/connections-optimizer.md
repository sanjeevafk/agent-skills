...
<!-- Source of truth: skills/connections-optimizer/SKILL.md -->
---
description: "Reorganize the user's X and LinkedIn network with review-first pruning, add/follow recommendations, and channel-specific warm outreach drafted in the user's real voice. Use when the user wants to clean up following lists, grow toward current priorities, or rebalance a social graph around higher-signal relationships."
category: "workflow"
namespace: "/workflow/connections-optimizer"
flat_command: "/connections-optimizer"
---

# Command: connections-optimizer (/workflow/connections-optimizer)

> **Trigger**: Reorganize the user's X and LinkedIn network with review-first pruning, add/follow recommendations, and channel-specific warm outreach drafted in the user's real voice. Use when the user wants to clean up following lists, grow toward current priorities, or rebalance a social graph around higher-signal relationships.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/connections-optimizer/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/connections-optimizer/SKILL.md)
