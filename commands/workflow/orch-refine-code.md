...
<!-- Source of truth: skills/orch-refine-code/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/orch-refine-code"
flat_command: "/orch-refine-code"
---

# Command: orch-refine-code (/workflow/orch-refine-code)

> **Trigger**: Orchestrate a behavior-preserving refactor — confirm tests are green, restructure without changing behavior, keep tests green, review, and gated commit. Use when the structure should improve but behavior must not change.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/orch-refine-code/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/orch-refine-code/SKILL.md)
