...
<!-- Source of truth: skills/architecture-decision-records/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/architecture-decision-records"
flat_command: "/architecture-decision-records"
---

# Command: architecture-decision-records (/workflow/architecture-decision-records)

> **Trigger**: Capture architectural decisions made during Claude Code sessions as structured ADRs. Auto-detects decision moments, records context, alternatives considered, and rationale. Maintains an ADR log so future developers understand why the codebase is shaped the way it is.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/architecture-decision-records/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/architecture-decision-records/SKILL.md)
