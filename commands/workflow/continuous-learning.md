...
<!-- Source of truth: skills/continuous-learning/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/continuous-learning"
flat_command: "/continuous-learning"
---

# Command: continuous-learning (/workflow/continuous-learning)

> **Trigger**: [DEPRECATED - use continuous-learning-v2] Legacy v1 stop-hook skill extractor. v2 is a strict superset with instinct-based, project-scoped, hook-reliable learning. Do not invoke v1; route continuous learning, session learning, and pattern extraction requests to continuous-learning-v2.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/continuous-learning/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/continuous-learning/SKILL.md)
