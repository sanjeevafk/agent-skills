...
<!-- Source of truth: skills/code-refactor/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/code-refactor"
flat_command: "/code-refactor"
---

# Command: code-refactor (/workflow/code-refactor)

> **Trigger**: Perform bulk code refactoring operations like renaming variables/functions across files, replacing patterns, and updating API calls. Use when users request renaming identifiers, replacing deprecated code patterns, updating method calls, or making consistent changes across multiple locations.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/code-refactor/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/code-refactor/SKILL.md)
