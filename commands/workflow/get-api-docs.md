...
<!-- Source of truth: skills/context-hub-get-api-docs/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/get-api-docs"
flat_command: "/get-api-docs"
---

# Command: get-api-docs (/workflow/get-api-docs)

> **Trigger**: Use this skill when you need documentation for a third-party library, SDK, or API before writing code that uses it — for example, \"use the OpenAI API\", \"call the Stripe API\", \"use the Anthropic SDK\", \"query Pinecone\", or any time the user asks you to write code against an external service and you need current API reference. Fetch the docs with chub before answering, rather than relying on training knowledge.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/context-hub-get-api-docs/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/context-hub-get-api-docs/SKILL.md)
