...
<!-- Source of truth: skills/screenshot/SKILL.md -->
---
description: "Use when the user explicitly asks for a desktop or system screenshot (full screen, specific app or window, or a pixel region), or when tool-specific capture capabilities are unavailable and an OS-level capture is needed."
category: "workflow"
namespace: "/workflow/screenshot"
flat_command: "/screenshot"
---

# Command: screenshot (/workflow/screenshot)

> **Trigger**: Use when the user explicitly asks for a desktop or system screenshot (full screen, specific app or window, or a pixel region), or when tool-specific capture capabilities are unavailable and an OS-level capture is needed.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/screenshot/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/screenshot/SKILL.md)
