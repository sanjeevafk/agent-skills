...
<!-- Source of truth: skills/tdd-workflow/SKILL.md -->
---
description: "Use this skill when writing new features, fixing bugs, or refactoring code. Enforces test-driven development with 80%+ coverage including unit, integration, and E2E tests."
category: "workflow"
namespace: "/workflow/tdd-workflow"
flat_command: "/tdd-workflow"
---

# Command: tdd-workflow (/workflow/tdd-workflow)

> **Trigger**: Use this skill when writing new features, fixing bugs, or refactoring code. Enforces test-driven development with 80%+ coverage including unit, integration, and E2E tests.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/tdd-workflow/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/tdd-workflow/SKILL.md)
