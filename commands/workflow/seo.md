...
<!-- Source of truth: skills/seo/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/seo"
flat_command: "/seo"
---

# Command: seo (/workflow/seo)

> **Trigger**: Audit, plan, and implement SEO improvements across technical SEO, on-page optimization, structured data, Core Web Vitals, and content strategy. Use when the user wants better search visibility, SEO remediation, schema markup, sitemap/robots work, or keyword mapping.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/seo/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/seo/SKILL.md)
