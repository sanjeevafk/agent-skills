...
<!-- Source of truth: skills/sentry-sdk-upgrade/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/sdk-upgrade"
flat_command: "/sentry-sdk-upgrade"
---

# Command: sentry-sdk-upgrade (/workflow/sdk-upgrade)

> **Trigger**: Upgrade the Sentry JavaScript SDK across major versions. Use when asked to upgrade Sentry, migrate to a newer version, fix deprecated Sentry APIs, or resolve breaking changes after a Sentry version bump.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/sentry-sdk-upgrade/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-sdk-upgrade/SKILL.md)
