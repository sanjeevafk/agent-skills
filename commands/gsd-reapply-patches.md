...
<!-- Source of truth: skills/gsd-reapply-patches/SKILL.md -->
---
description: "Reapply local modifications after a GSD update"
category: "gsd"
namespace: "/gsd/reapply-patches"
flat_command: "/gsd-reapply-patches"
---

# Command: gsd-reapply-patches (/gsd/reapply-patches)

> **Trigger**: Reapply local modifications after a GSD update
> **Category**: GSD Project Management
> **Source Skill**: [skills/gsd-reapply-patches/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/gsd-reapply-patches/SKILL.md)
