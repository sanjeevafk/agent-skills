...
<!-- Source of truth: skills/regex-vs-llm-structured-text/SKILL.md -->
---
description: "Decision framework for choosing between regex and LLM when parsing structured text — start with regex, add LLM only for low-confidence edge cases."
category: "web"
namespace: "/web/regex-vs-llm-structured-text"
flat_command: "/regex-vs-llm-structured-text"
---

# Command: regex-vs-llm-structured-text (/web/regex-vs-llm-structured-text)
...
> **Source Skill**: [skills/regex-vs-llm-structured-text/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/regex-vs-llm-structured-text/SKILL.md)
