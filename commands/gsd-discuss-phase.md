...
<!-- Source of truth: skills/gsd-discuss-phase/SKILL.md -->
---
...
category: "gsd"
namespace: "/gsd/discuss-phase"
flat_command: "/gsd-discuss-phase"
---

# Command: gsd-discuss-phase (/gsd/discuss-phase)

> **Trigger**: Gather phase context through adaptive questioning before planning. Use --auto to skip interactive questions (Claude picks recommended defaults).
> **Category**: GSD Project Management
> **Source Skill**: [skills/gsd-discuss-phase/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/gsd-discuss-phase/SKILL.md)
