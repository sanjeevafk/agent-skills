...
<!-- Source of truth: skills/product-capability/SKILL.md -->
---
description: "Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an ECC-native PRD-to-SRS lane instead of vague planning prose."
category: "web"
namespace: "/web/product-capability"
flat_command: "/product-capability"
---

# Command: product-capability (/web/product-capability)

> **Trigger**: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an ECC-native PRD-to-SRS lane instead of vague planning prose.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/product-capability/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/product-capability/SKILL.md)
