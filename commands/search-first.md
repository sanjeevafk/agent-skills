...
<!-- Source of truth: skills/search-first/SKILL.md -->
---
description: "Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Invokes the researcher agent."
category: "ai-ml"
namespace: "/ai-ml/search-first"
flat_command: "/search-first"
---

# Command: search-first (/ai-ml/search-first)

> **Trigger**: Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Invokes the researcher agent.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/search-first/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/search-first/SKILL.md)
