...
<!-- Source of truth: skills/codehealth-mcp/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/codehealth-mcp"
flat_command: "/codehealth-mcp"
---

# Command: codehealth-mcp (/ai-ml/codehealth-mcp)

> **Trigger**: Real-time structural Code Health via CodeScene MCP — review before edits, verify score deltas after changes, gate commits and PRs. Use when reviewing code quality, refactoring, checking if AI changes degraded a file, or before commit/PR.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/codehealth-mcp/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/codehealth-mcp/SKILL.md)
