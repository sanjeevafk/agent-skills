...
<!-- Source of truth: skills/windows-desktop-e2e/SKILL.md -->
---
...
category: "security"
namespace: "/security/windows-desktop-e2e"
flat_command: "/windows-desktop-e2e"
---

# Command: windows-desktop-e2e (/security/windows-desktop-e2e)

> **Trigger**: E2E testing for Windows native desktop apps (WPF, WinForms, Win32/MFC, Qt) using pywinauto and Windows UI Automation.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/windows-desktop-e2e/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/windows-desktop-e2e/SKILL.md)
