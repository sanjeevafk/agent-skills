...
<!-- Source of truth: skills/agent-sort/SKILL.md -->
---
description: "Build an evidence-backed ECC install plan for a specific repo by sorting skills, commands, rules, hooks, and extras into DAILY vs LIBRARY buckets using parallel repo-aware review passes. Use when ECC should be trimmed to what a project actually needs instead of loading the full bundle."
category: "web"
namespace: "/web/agent-sort"
flat_command: "/agent-sort"
---

# Command: agent-sort (/web/agent-sort)

> **Trigger**: Build an evidence-backed ECC install plan for a specific repo by sorting skills, commands, rules, hooks, and extras into DAILY vs LIBRARY buckets using parallel repo-aware review passes. Use when ECC should be trimmed to what a project actually needs instead of loading the full bundle.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/agent-sort/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/agent-sort/SKILL.md)
