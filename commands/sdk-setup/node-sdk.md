...
<!-- Source of truth: skills/sentry-node-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/node-sdk"
flat_command: "/sentry-node-sdk"
---

# Command: sentry-node-sdk (/sdk-setup/node-sdk)

> **Trigger**: Full Sentry SDK setup for Node.js, Bun, and Deno. Use when asked to \"add Sentry to Node.js\", \"add Sentry to Bun\", \"add Sentry to Deno\", \"install @sentry/node\", \"@sentry/bun\", or \"@sentry/deno\", or configure error monitoring, tracing, logging, profiling, metrics, crons, or AI monitoring for server-side JavaScript/TypeScript runtimes.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-node-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-node-sdk/SKILL.md)
