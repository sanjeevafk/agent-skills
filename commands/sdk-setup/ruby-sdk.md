...
<!-- Source of truth: skills/sentry-ruby-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/ruby-sdk"
flat_command: "/sentry-ruby-sdk"
---

# Command: sentry-ruby-sdk (/sdk-setup/ruby-sdk)

> **Trigger**: Full Sentry SDK setup for Ruby. Use when asked to add Sentry to Ruby, install sentry-ruby, setup Sentry in Rails/Sinatra/Rack, or configure error monitoring, tracing, logging, metrics, profiling, or crons for Ruby applications. Also handles migration from AppSignal, Honeybadger, Bugsnag, Rollbar, or Airbrake. Supports Rails, Sinatra, Rack, Sidekiq, and Resque.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-ruby-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-ruby-sdk/SKILL.md)
