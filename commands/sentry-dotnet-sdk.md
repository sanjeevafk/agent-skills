...
<!-- Source of truth: skills/sentry-dotnet-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/dotnet-sdk"
flat_command: "/sentry-dotnet-sdk"
---

# Command: sentry-dotnet-sdk (/sdk-setup/dotnet-sdk)

> **Trigger**: Full Sentry SDK setup for .NET. Use when asked to \"add Sentry to .NET\", \"install Sentry for C#\", or configure error monitoring, tracing, profiling, logging, or crons for ASP.NET Core, MAUI, WPF, WinForms, Blazor, Azure Functions, or any other .NET application.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-dotnet-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-dotnet-sdk/SKILL.md)
