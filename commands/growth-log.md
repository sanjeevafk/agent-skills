...
<!-- Source of truth: skills/growth-log/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/growth-log"
flat_command: "/growth-log"
---

# Command: growth-log (/workflow/growth-log)

> **Trigger**: Use after a complex task, failure, or when reviewing what was learned. Teaches how to write growth logs that extract reusable patterns — not diary entries.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/growth-log/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/growth-log/SKILL.md)
