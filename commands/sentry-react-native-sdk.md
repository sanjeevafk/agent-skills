...
<!-- Source of truth: skills/sentry-react-native-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/react-native-sdk"
flat_command: "/sentry-react-native-sdk"
---

# Command: sentry-react-native-sdk (/sdk-setup/react-native-sdk)

> **Trigger**: Full Sentry SDK setup for React Native and Expo. Use when asked to \"add Sentry to React Native\", \"install @sentry/react-native\", \"setup Sentry in Expo\", or configure error monitoring, tracing, profiling, session replay, or logging for React Native applications. Supports Expo managed, Expo bare, and vanilla React Native.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-react-native-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-react-native-sdk/SKILL.md)
