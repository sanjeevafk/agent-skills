...
<!-- Source of truth: skills/render-deploy/SKILL.md -->
---
...
category: "web"
namespace: "/web/render-deploy"
flat_command: "/render-deploy"
---

# Command: render-deploy (/web/render-deploy)

> **Trigger**: Deploy applications to Render by analyzing codebases, generating render.yaml Blueprints, and providing Dashboard deeplinks. Use when the user wants to deploy, host, publish, or set up their application on Render's cloud platform.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/render-deploy/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/render-deploy/SKILL.md)
