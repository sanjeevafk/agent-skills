...
<!-- Source of truth: skills/hookify-rules/SKILL.md -->
---
description: "This skill should be used when the user asks to create a hookify rule, write a hook rule, configure hookify, add a hookify rule, or needs guidance on hookify rule syntax and patterns."
category: "web"
namespace: "/web/hookify-rules"
flat_command: "/hookify-rules"
---

# Command: hookify-rules (/web/hookify-rules)
...
> **Source Skill**: [skills/hookify-rules/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/hookify-rules/SKILL.md)
