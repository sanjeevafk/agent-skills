...
<!-- Source of truth: rules/agent-rules-books/domain-driven-design.md -->
---
description: "Rule: domain-driven-design"
category: "rule"
namespace: "/rule/domain-driven-design"
flat_command: "/rule-domain-driven-design"
---

# Rule Command: /rule/domain-driven-design

> **Source Rule File**: [rules/agent-rules-books/domain-driven-design.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/domain-driven-design.md)
