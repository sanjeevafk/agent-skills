...
<!-- Source of truth: skills/orch-build-mvp/SKILL.md -->
---
...
category: "web"
namespace: "/web/orch-build-mvp"
flat_command: "/orch-build-mvp"
---

# Command: orch-build-mvp (/web/orch-build-mvp)

> **Trigger**: Orchestrate bootstrapping a working MVP from a design or spec document — ingest the doc, plan thin vertical slices, scaffold the first end-to-end slice, then TDD-implement, review, and gated commit. Use to turn an SDD/PRD into a running starting point.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/orch-build-mvp/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/orch-build-mvp/SKILL.md)
