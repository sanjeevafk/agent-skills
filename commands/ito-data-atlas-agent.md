...
<!-- Source of truth: skills/ito-data-atlas-agent/SKILL.md -->
---
...
category: "web"
namespace: "/web/ito-data-atlas-agent"
flat_command: "/ito-data-atlas-agent"
---

# Command: ito-data-atlas-agent (/web/ito-data-atlas-agent)

> **Trigger**: Design background Data Atlas style agents for Itô basket research, market discovery, parameter drafting, and human-in-the-loop editing. Use for architecture and workflow planning, not live order execution.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/ito-data-atlas-agent/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ito-data-atlas-agent/SKILL.md)
