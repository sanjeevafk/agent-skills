...
<!-- Source of truth: skills/research-ops/SKILL.md -->
---
...
category: "web"
namespace: "/web/research-ops"
flat_command: "/research-ops"
---

# Command: research-ops (/web/research-ops)

> **Trigger**: Evidence-first current-state research workflow for ECC. Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/research-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/research-ops/SKILL.md)
