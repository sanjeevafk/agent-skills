...
<!-- Source of truth: skills/unified-notifications-ops/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/unified-notifications-ops"
flat_command: "/unified-notifications-ops"
---

# Command: unified-notifications-ops (/workflow/unified-notifications-ops)

> **Trigger**: Operate notifications as one ECC-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces. Use when the real problem is alert routing, deduplication, escalation, or inbox collapse.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/unified-notifications-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/unified-notifications-ops/SKILL.md)
