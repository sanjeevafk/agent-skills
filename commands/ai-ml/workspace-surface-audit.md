...
<!-- Source of truth: skills/workspace-surface-audit/SKILL.md -->
---
description: "Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up Claude Code or understanding what capabilities are actually available in their environment."
category: "ai-ml"
namespace: "/ai-ml/workspace-surface-audit"
flat_command: "/workspace-surface-audit"
---

# Command: workspace-surface-audit (/ai-ml/workspace-surface-audit)

> **Trigger**: Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up Claude Code or understanding what capabilities are actually available in their environment.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/workspace-surface-audit/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/workspace-surface-audit/SKILL.md)
