...
<!-- Source of truth: skills/claude-automation-recommender/SKILL.md -->
---
description: "Analyze a codebase and recommend Claude Code automations (hooks, subagents, skills, plugins, MCP servers). Use when user asks for automation recommendations, wants to optimize their Claude Code setup, mentions improving Claude Code workflows, asks how to first set up Claude Code for a project, or wants to know what Claude Code features they should use."
category: "ai-ml"
namespace: "/ai-ml/claude-automation-recommender"
flat_command: "/claude-automation-recommender"
---

# Command: claude-automation-recommender (/ai-ml/claude-automation-recommender)

> **Trigger**: Analyze a codebase and recommend Claude Code automations (hooks, subagents, skills, plugins, MCP servers). Use when user asks for automation recommendations, wants to optimize their Claude Code setup, mentions improving Claude Code workflows, asks how to first set up Claude Code for a project, or wants to know what Claude Code features they should use.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/claude-automation-recommender/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/claude-automation-recommender/SKILL.md)
