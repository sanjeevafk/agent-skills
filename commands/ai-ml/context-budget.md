...
<!-- Source of truth: skills/context-budget/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/context-budget"
flat_command: "/context-budget"
---

# Command: context-budget (/ai-ml/context-budget)

> **Trigger**: Audits Claude Code context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/context-budget/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/context-budget/SKILL.md)
