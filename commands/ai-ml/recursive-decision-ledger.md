...
<!-- Source of truth: skills/recursive-decision-ledger/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/recursive-decision-ledger"
flat_command: "/recursive-decision-ledger"
---

# Command: recursive-decision-ledger (/ai-ml/recursive-decision-ledger)

> **Trigger**: Use when the user asks for repeated rollouts, marked decision processes, high-dimensional search, stochastic optimization, local-optima exploration, ensemble comparison, or recursive reasoning with a visible evidence trail.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/recursive-decision-ledger/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/recursive-decision-ledger/SKILL.md)
