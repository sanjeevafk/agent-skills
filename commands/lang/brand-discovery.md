...
<!-- Source of truth: skills/brand-discovery/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/brand-discovery"
flat_command: "/brand-discovery"
---

# Command: brand-discovery (/lang/brand-discovery)

> **Trigger**: Use when a brand needs to discover or articulate its identity through structured multi-session interviews. Covers purpose, positioning, audience, personality, voice, narrative, and founder-brand tension across 8 modules using laddering, 5 Whys, and projective techniques. Produces a resumable session with disk-persisted state and a master brandbook (90_SYNTHESIS.md).
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/brand-discovery/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/brand-discovery/SKILL.md)
