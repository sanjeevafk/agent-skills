...
<!-- Source of truth: skills/database-migrations/SKILL.md -->
---
...
flat_command: "/database-migrations"
---

# Command: database-migrations (/lang/database-migrations)

> **Trigger**: Database migration best practices for schema changes, data migrations, rollbacks, and zero-downtime deployments across PostgreSQL, MySQL, and common ORMs (Prisma, Drizzle, Kysely, Django, TypeORM, golang-migrate).
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/database-migrations/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/database-migrations/SKILL.md)
