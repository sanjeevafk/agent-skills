...
<!-- Source of truth: skills/google-workspace-ops/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/google-workspace-ops"
flat_command: "/google-workspace-ops"
---

# Command: google-workspace-ops (/lang/google-workspace-ops)

> **Trigger**: Operate across Google Drive, Docs, Sheets, and Slides as one workflow surface for plans, trackers, decks, and shared documents. Use when the user needs to find, summarize, edit, migrate, or clean up Google Workspace assets without dropping to raw tool calls.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/google-workspace-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/google-workspace-ops/SKILL.md)
