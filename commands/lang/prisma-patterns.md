...
<!-- Source of truth: skills/prisma-patterns/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/prisma-patterns"
flat_command: "/prisma-patterns"
---

# Command: prisma-patterns (/lang/prisma-patterns)

> **Trigger**: Prisma ORM patterns for TypeScript backends — schema design, query optimization, transactions, pagination, and critical traps like updateMany returning count not records, $transaction timeouts, migrate dev resetting the DB, @updatedAt skipped on bulk writes, and serverless connection exhaustion.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/prisma-patterns/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/prisma-patterns/SKILL.md)
