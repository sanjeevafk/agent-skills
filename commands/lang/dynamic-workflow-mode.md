...
<!-- Source of truth: skills/dynamic-workflow-mode/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/dynamic-workflow-mode"
flat_command: "/dynamic-workflow-mode"
---

# Command: dynamic-workflow-mode (/lang/dynamic-workflow-mode)

> **Trigger**: Design task-local harnesses, eval gates, and reusable skill extraction for Claude dynamic workflow mode and other adaptive agent harnesses.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/dynamic-workflow-mode/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/dynamic-workflow-mode/SKILL.md)
