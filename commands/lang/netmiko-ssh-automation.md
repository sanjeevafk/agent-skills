...
<!-- Source of truth: skills/netmiko-ssh-automation/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/netmiko-ssh-automation"
flat_command: "/netmiko-ssh-automation"
---

# Command: netmiko-ssh-automation (/lang/netmiko-ssh-automation)

> **Trigger**: Safe Python Netmiko patterns for read-only collection, bounded batch SSH, TextFSM parsing, guarded config changes, timeouts, and network automation error handling.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/netmiko-ssh-automation/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/netmiko-ssh-automation/SKILL.md)
