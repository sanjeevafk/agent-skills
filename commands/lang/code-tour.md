...
<!-- Source of truth: skills/code-tour/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/code-tour"
flat_command: "/code-tour"
---

# Command: code-tour (/lang/code-tour)

> **Trigger**: Create CodeTour `.tour` files — persona-targeted, step-by-step walkthroughs with real file and line anchors. Use for onboarding tours, architecture walkthroughs, PR tours, RCA tours, and structured \"explain how this works\" requests.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/code-tour/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/code-tour/SKILL.md)
