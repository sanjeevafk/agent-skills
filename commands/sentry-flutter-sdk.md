...
<!-- Source of truth: skills/sentry-flutter-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/flutter-sdk"
flat_command: "/sentry-flutter-sdk"
---

# Command: sentry-flutter-sdk (/sdk-setup/flutter-sdk)

> **Trigger**: Full Sentry SDK setup for Flutter and Dart. Use when asked to \"add Sentry to Flutter\", \"install sentry_flutter\", \"setup Sentry in Dart\", or configure error monitoring, tracing, profiling, session replay, or logging for Flutter applications. Supports Android, iOS, macOS, Linux, Windows, and Web.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-flutter-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-flutter-sdk/SKILL.md)
