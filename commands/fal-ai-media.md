...
<!-- Source of truth: skills/fal-ai-media/SKILL.md -->
---
description: "Unified media generation via fal.ai MCP — image, video, and audio. Covers text-to-image (Nano Banana), text/image-to-video (Seedance, Kling, Veo 3), text-to-speech (CSM-1B), and video-to-audio (ThinkSound). Use when the user wants to generate images, videos, or audio with AI."
category: "web"
namespace: "/web/fal-ai-media"
flat_command: "/fal-ai-media"
---

# Command: fal-ai-media (/web/fal-ai-media)

> **Trigger**: Unified media generation via fal.ai MCP — image, video, and audio. Covers text-to-image (Nano Banana), text/image-to-video (Seedance, Kling, Veo 3), text-to-speech (CSM-1B), and video-to-audio (ThinkSound). Use when the user wants to generate images, videos, or audio with AI.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/fal-ai-media/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/fal-ai-media/SKILL.md)
