...
<!-- Source of truth: skills/team-agent-orchestration/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/team-agent-orchestration"
flat_command: "/team-agent-orchestration"
---

# Command: team-agent-orchestration (/ai-ml/team-agent-orchestration)

> **Trigger**: Run team-based orchestration for agent squads using work items, ownership, agent Kanban, merge gates, and control pane handoffs.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/team-agent-orchestration/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/team-agent-orchestration/SKILL.md)
