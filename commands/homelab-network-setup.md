...
<!-- Source of truth: skills/homelab-network-setup/SKILL.md -->
---
...
category: "web"
namespace: "/web/homelab-network-setup"
flat_command: "/homelab-network-setup"
---

# Command: homelab-network-setup (/web/homelab-network-setup)

> **Trigger**: Practical home and homelab network planning for gateways, switches, access points, IP ranges, DHCP reservations, DNS, cabling, and common beginner mistakes.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/homelab-network-setup/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/homelab-network-setup/SKILL.md)
