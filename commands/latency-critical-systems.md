...
<!-- Source of truth: skills/latency-critical-systems/SKILL.md -->
---
...
category: "security"
namespace: "/security/latency-critical-systems"
flat_command: "/latency-critical-systems"
---

# Command: latency-critical-systems (/security/latency-critical-systems)

> **Trigger**: Use for latency-sensitive systems such as realtime dashboards, market data, streaming agents, execution gateways, queues, caches, or HFT-like infrastructure where freshness and p95 latency matter.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/latency-critical-systems/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/latency-critical-systems/SKILL.md)
