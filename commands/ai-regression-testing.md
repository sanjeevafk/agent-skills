...
<!-- Source of truth: skills/ai-regression-testing/SKILL.md -->
---
...
category: "data"
namespace: "/data/ai-regression-testing"
flat_command: "/ai-regression-testing"
---

# Command: ai-regression-testing (/data/ai-regression-testing)

> **Trigger**: Regression testing strategies for AI-assisted development. Sandbox-mode API testing without database dependencies, automated bug-check workflows, and patterns to catch AI blind spots where the same model writes and reviews code.
> **Category**: Databases & Data Engineering
> **Source Skill**: [skills/ai-regression-testing/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ai-regression-testing/SKILL.md)
