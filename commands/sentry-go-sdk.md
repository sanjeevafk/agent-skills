...
<!-- Source of truth: skills/sentry-go-sdk/SKILL.md -->
---
...
category: "sdk-setup"
namespace: "/sdk-setup/go-sdk"
flat_command: "/sentry-go-sdk"
---

# Command: sentry-go-sdk (/sdk-setup/go-sdk)

> **Trigger**: Full Sentry SDK setup for Go. Use when asked to \"add Sentry to Go\", \"install sentry-go\", \"setup Sentry in Go\", or configure error monitoring, tracing, logging, metrics, or crons for Go applications. Supports net/http, Gin, Echo, Fiber, FastHTTP, Iris, and Negroni.
> **Category**: Sdk-Setup
> **Source Skill**: [skills/sentry-go-sdk/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-go-sdk/SKILL.md)
