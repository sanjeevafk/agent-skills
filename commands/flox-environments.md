...
<!-- Source of truth: skills/flox-environments/SKILL.md -->
---
...
category: "web"
namespace: "/web/flox-environments"
flat_command: "/flox-environments"
---

# Command: flox-environments (/web/flox-environments)

> **Trigger**: Create reproducible, cross-platform (macOS/Linux) development environments with Flox, a declarative Nix-based environment manager. Use when setting up project toolchains for any language, installing system-level dependencies (compilers, databases, native libs like openssl/BLAS), pinning exact package versions for a team, running local services (PostgreSQL, Redis, Kafka), onboarding developers with one command, or solving 'works on my machine' problems — including agent/vibe-coding setups that need project-scoped tools without sudo. Also use when the user mentions .flox/, manifest.toml, flox activate, or FloxHub.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/flox-environments/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/flox-environments/SKILL.md)
