...
<!-- Source of truth: skills/sentry-feature-setup/SKILL.md -->
---
...
namespace: "/observability/feature-setup"
flat_command: "/sentry-feature-setup"
---

# Command: sentry-feature-setup (/observability/feature-setup)

> **Trigger**: Configure specific Sentry features beyond basic SDK setup. Use when asked to monitor AI/LLM calls, set up OpenTelemetry pipelines, or create alerts and notifications.
> **Category**: Observability & Monitoring
> **Source Skill**: [skills/sentry-feature-setup/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-feature-setup/SKILL.md)
