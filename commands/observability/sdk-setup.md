...
<!-- Source of truth: skills/sentry-sdk-setup/SKILL.md -->
---
...
namespace: "/observability/sdk-setup"
flat_command: "/sentry-sdk-setup"
---

# Command: sentry-sdk-setup (/observability/sdk-setup)

> **Trigger**: Set up Sentry in any language or framework. Detects the user's platform and loads the right SDK skill. Use when asked to add Sentry, install an SDK, or set up error monitoring in a project.
> **Category**: Observability & Monitoring
> **Source Skill**: [skills/sentry-sdk-setup/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-sdk-setup/SKILL.md)
