...
<!-- Source of truth: skills/mysql-patterns/SKILL.md -->
---
...
category: "data"
namespace: "/data/mysql-patterns"
flat_command: "/mysql-patterns"
---

# Command: mysql-patterns (/data/mysql-patterns)

> **Trigger**: MySQL and MariaDB schema, query, indexing, transaction, replication, and connection-pool patterns for production backends.
> **Category**: Databases & Data Engineering
> **Source Skill**: [skills/mysql-patterns/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/mysql-patterns/SKILL.md)
