...
<!-- Source of truth: skills/ecc-tools-cost-audit/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/ecc-tools-cost-audit"
flat_command: "/ecc-tools-cost-audit"
---

# Command: ecc-tools-cost-audit (/workflow/ecc-tools-cost-audit)

> **Trigger**: Evidence-first ECC Tools burn and billing audit workflow. Use when investigating runaway PR creation, quota bypass, premium-model leakage, duplicate jobs, or GitHub App cost spikes in the ECC Tools repo.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/ecc-tools-cost-audit/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ecc-tools-cost-audit/SKILL.md)
