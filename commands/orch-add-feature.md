...
<!-- Source of truth: skills/orch-add-feature/SKILL.md -->
---
...
category: "web"
namespace: "/web/orch-add-feature"
flat_command: "/orch-add-feature"
---

# Command: orch-add-feature (/web/orch-add-feature)

> **Trigger**: Orchestrate building a brand-new feature end to end — research, plan, TDD implementation, review, and gated commit — by delegating each phase to the matching ECC agent. Use when adding a capability that does not exist yet.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/orch-add-feature/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/orch-add-feature/SKILL.md)
