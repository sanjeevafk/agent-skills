...
<!-- Source of truth: skills/rules-distill/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/rules-distill"
flat_command: "/rules-distill"
---

# Command: rules-distill (/ai-ml/rules-distill)

> **Trigger**: Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/rules-distill/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/rules-distill/SKILL.md)
