...
<!-- Source of truth: skills/skill-stocktake/SKILL.md -->
---
description: "Use when auditing Claude skills and commands for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation."
category: "web"
namespace: "/web/skill-stocktake"
flat_command: "/skill-stocktake"
---

# Command: skill-stocktake (/web/skill-stocktake)

> **Trigger**: Use when auditing Claude skills and commands for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/skill-stocktake/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/skill-stocktake/SKILL.md)
