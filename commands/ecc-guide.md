...
<!-- Source of truth: skills/ecc-guide/SKILL.md -->
---
...
category: "web"
namespace: "/web/ecc-guide"
flat_command: "/ecc-guide"
---

# Command: ecc-guide (/web/ecc-guide)

> **Trigger**: Guide users through ECC's current agents, skills, commands, hooks, rules, install profiles, and project onboarding by reading the live repository surface before answering.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/ecc-guide/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/ecc-guide/SKILL.md)
