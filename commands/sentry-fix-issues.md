...
<!-- Source of truth: skills/sentry-fix-issues/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/fix-issues"
flat_command: "/sentry-fix-issues"
---

# Command: sentry-fix-issues (/workflow/fix-issues)

> **Trigger**: Find and fix issues from Sentry using MCP. Use when asked to fix Sentry errors, debug production issues, investigate exceptions, or resolve bugs reported in Sentry. Methodically analyzes stack traces, breadcrumbs, traces, and context to identify root causes.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/sentry-fix-issues/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-fix-issues/SKILL.md)
