...
<!-- Source of truth: rules/agent-rules-books/code-complete.md -->
---
description: "Rule: code-complete"
category: "rule"
namespace: "/rule/code-complete"
flat_command: "/rule-code-complete"
---

# Rule Command: /rule/code-complete

> **Source Rule File**: [rules/agent-rules-books/code-complete.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/code-complete.md)
