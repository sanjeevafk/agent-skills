...
<!-- Source of truth: skills/knowledge-ops/SKILL.md -->
---
...
category: "ai-ml"
namespace: "/ai-ml/knowledge-ops"
flat_command: "/knowledge-ops"
---

# Command: knowledge-ops (/ai-ml/knowledge-ops)

> **Trigger**: Knowledge base management, ingestion, sync, and retrieval across multiple storage layers (local files, MCP memory, vector stores, Git repos). Use when the user wants to save, organize, sync, deduplicate, or search across their knowledge systems.
> **Category**: AI Engineering, Evals & Agents
> **Source Skill**: [skills/knowledge-ops/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/knowledge-ops/SKILL.md)
