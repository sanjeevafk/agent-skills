...
<!-- Source of truth: skills/repo-scan/SKILL.md -->
---
...
category: "web"
namespace: "/web/repo-scan"
flat_command: "/repo-scan"
---

# Command: repo-scan (/web/repo-scan)

> **Trigger**: Cross-stack source code asset audit — classifies every file, detects embedded third-party libraries, and delivers actionable four-level verdicts per module with interactive HTML reports.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/repo-scan/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/repo-scan/SKILL.md)
