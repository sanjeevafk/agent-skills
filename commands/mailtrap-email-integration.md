...
<!-- Source of truth: skills/mailtrap-email-integration/SKILL.md -->
---
...
category: "debug"
namespace: "/debug/mailtrap-email-integration"
flat_command: "/mailtrap-email-integration"
---

# Command: mailtrap-email-integration (/debug/mailtrap-email-integration)

> **Trigger**: Guides agents through integrating transactional email sending via Mailtrap's Email API, including sandbox testing, domain verification, and API authentication. Use when implementing email-sending features, debugging delivery issues, or setting up safe dev/staging email testing.
> **Category**: Debugging & Diagnostics
> **Source Skill**: [skills/mailtrap-email-integration/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/mailtrap-email-integration/SKILL.md)
