...
<!-- Source of truth: skills/delivery-gate/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/delivery-gate"
flat_command: "/delivery-gate"
---

# Command: delivery-gate (/workflow/delivery-gate)

> **Trigger**: Stop hook that blocks Claude from finishing until quality checks pass. Detects rationalization patterns (surface text heuristics), stale learning logs (filesystem mtime), and low disk space. Complements self-audit by mechanically enforcing learning capture habits.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/delivery-gate/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/delivery-gate/SKILL.md)
