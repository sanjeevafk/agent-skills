...
<!-- Source of truth: skills/network-bgp-diagnostics/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/network-bgp-diagnostics"
flat_command: "/network-bgp-diagnostics"
---

# Command: network-bgp-diagnostics (/workflow/network-bgp-diagnostics)

> **Trigger**: Diagnostics-only BGP troubleshooting patterns for neighbor state, route exchange, prefix policy, AS path inspection, and safe evidence collection.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/network-bgp-diagnostics/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/network-bgp-diagnostics/SKILL.md)
