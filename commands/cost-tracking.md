...
<!-- Source of truth: skills/cost-tracking/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/cost-tracking"
flat_command: "/cost-tracking"
---

# Command: cost-tracking (/workflow/cost-tracking)

> **Trigger**: Track and report Claude Code token usage, spending, and budgets from the local ECC cost-tracker metrics log. Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by model, session, or date.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/cost-tracking/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/cost-tracking/SKILL.md)
