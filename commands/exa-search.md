...
<!-- Source of truth: skills/exa-search/SKILL.md -->
---
description: "Neural search via Exa MCP for web, code, and company research. Use when the user needs web search, code examples, company intel, people lookup, or AI-powered deep research with Exa's neural search engine."
category: "lang"
namespace: "/lang/exa-search"
flat_command: "/exa-search"
---

# Command: exa-search (/lang/exa-search)

> **Trigger**: Neural search via Exa MCP for web, code, and company research. Use when the user needs web search, code examples, company intel, people lookup, or AI-powered deep research with Exa's neural search engine.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/exa-search/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/exa-search/SKILL.md)
