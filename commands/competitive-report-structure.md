...
<!-- Source of truth: skills/competitive-report-structure/SKILL.md -->
---
...
category: "security"
namespace: "/security/competitive-report-structure"
flat_command: "/competitive-report-structure"
---

# Command: competitive-report-structure (/security/competitive-report-structure)

> **Trigger**: Use after benchmark-methodology has produced scored competitor profile cards. Assembles findings into a decision-grade report: landscape map, competitor profiles, benchmarking matrix, white-space analysis, strategic recommendations, and team alignment trigger questions. Final step in the three-skill competitive pipeline.
> **Category**: Security, Compliance & Hardening
> **Source Skill**: [skills/competitive-report-structure/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/competitive-report-structure/SKILL.md)
