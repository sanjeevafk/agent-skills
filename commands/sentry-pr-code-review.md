...
<!-- Source of truth: skills/sentry-pr-code-review/SKILL.md -->
---
...
category: "workflow"
namespace: "/workflow/pr-code-review"
flat_command: "/sentry-pr-code-review"
---

# Command: sentry-pr-code-review (/workflow/pr-code-review)

> **Trigger**: Review a project's PRs to check for issues detected in code review by Seer Bug Prediction. Use when asked to review or fix issues identified by Sentry in PR comments, or to find recent PRs with Sentry feedback.
> **Category**: Engineering Workflows & Process
> **Source Skill**: [skills/sentry-pr-code-review/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-pr-code-review/SKILL.md)
