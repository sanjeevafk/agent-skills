...
<!-- Source of truth: rules/agent-rules-books/refactoring.md -->
---
description: "Rule: refactoring"
category: "rule"
namespace: "/rule/refactoring"
flat_command: "/rule-refactoring"
---

# Rule Command: /rule/refactoring

> **Source Rule File**: [rules/agent-rules-books/refactoring.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/refactoring.md)
