...
<!-- Source of truth: skills/sentry-otel-exporter-setup/SKILL.md -->
---
...
namespace: "/feature-setup/otel-exporter-setup"
flat_command: "/sentry-otel-exporter-setup"
---

# Command: sentry-otel-exporter-setup (/feature-setup/otel-exporter-setup)

> **Trigger**: Configure the OpenTelemetry Collector with Sentry Exporter for multi-project routing and automatic project creation. Use when setting up OTel with Sentry, configuring collector pipelines for traces and logs, or routing telemetry from multiple services to Sentry projects.
> **Category**: Feature-Setup
> **Source Skill**: [skills/sentry-otel-exporter-setup/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-otel-exporter-setup/SKILL.md)
