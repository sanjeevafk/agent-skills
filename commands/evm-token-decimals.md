...
<!-- Source of truth: skills/evm-token-decimals/SKILL.md -->
---
...
category: "lang"
namespace: "/lang/evm-token-decimals"
flat_command: "/evm-token-decimals"
---

# Command: evm-token-decimals (/lang/evm-token-decimals)

> **Trigger**: Prevent silent decimal mismatch bugs across EVM chains. Covers runtime decimal lookup, chain-aware caching, bridged-token precision drift, and safe normalization for bots, dashboards, and DeFi tools.
> **Category**: Programming Languages & Systems
> **Source Skill**: [skills/evm-token-decimals/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/evm-token-decimals/SKILL.md)
