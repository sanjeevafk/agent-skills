...
<!-- Source of truth: skills/configure-ecc/SKILL.md -->
---
...
category: "web"
namespace: "/web/configure-ecc"
flat_command: "/configure-ecc"
---

# Command: configure-ecc (/web/configure-ecc)

> **Trigger**: Interactive installer for Everything Claude Code — guides users through selecting and installing skills and rules to user-level or project-level directories, verifies paths, and optionally optimizes installed files.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/configure-ecc/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/configure-ecc/SKILL.md)
