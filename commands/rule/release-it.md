...
<!-- Source of truth: rules/agent-rules-books/release-it.md -->
---
description: "Rule: release-it"
category: "rule"
namespace: "/rule/release-it"
flat_command: "/rule-release-it"
---

# Rule Command: /rule/release-it

> **Source Rule File**: [rules/agent-rules-books/release-it.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/release-it.md)
