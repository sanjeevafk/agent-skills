...
<!-- Source of truth: rules/agent-rules-books/clean-architecture.md -->
---
description: "Rule: clean-architecture"
category: "rule"
namespace: "/rule/clean-architecture"
flat_command: "/rule-clean-architecture"
---

# Rule Command: /rule/clean-architecture

> **Source Rule File**: [rules/agent-rules-books/clean-architecture.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/clean-architecture.md)
