...
<!-- Source of truth: rules/agent-rules-books/working-effectively-with-legacy-code.md -->
---
description: "Rule: working-effectively-with-legacy-code"
category: "rule"
namespace: "/rule/working-effectively-with-legacy-code"
flat_command: "/rule-working-effectively-with-legacy-code"
---

# Rule Command: /rule/working-effectively-with-legacy-code

> **Source Rule File**: [rules/agent-rules-books/working-effectively-with-legacy-code.md](file:///home/sanjeev/Downloads/agent-skills/rules/agent-rules-books/working-effectively-with-legacy-code.md)
