...
<!-- Source of truth: skills/cisco-ios-patterns/SKILL.md -->
---
...
category: "web"
namespace: "/web/cisco-ios-patterns"
flat_command: "/cisco-ios-patterns"
---

# Command: cisco-ios-patterns (/web/cisco-ios-patterns)

> **Trigger**: Cisco IOS and IOS-XE review patterns for show commands, config hierarchy, wildcard masks, ACL placement, interface hygiene, and safe change-window verification.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/cisco-ios-patterns/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/cisco-ios-patterns/SKILL.md)
