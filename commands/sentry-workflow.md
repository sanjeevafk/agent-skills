...
<!-- Source of truth: skills/sentry-workflow/SKILL.md -->
---
...
namespace: "/observability/workflow"
flat_command: "/sentry-workflow"
---

# Command: sentry-workflow (/observability/workflow)

> **Trigger**: Fix production issues and review code with Sentry context. Use when asked to fix Sentry errors, debug issues, triage exceptions, review PR comments from Sentry, or resolve bugs.
> **Category**: Observability & Monitoring
> **Source Skill**: [skills/sentry-workflow/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/sentry-workflow/SKILL.md)
