...
<!-- Source of truth: skills/brand-voice/SKILL.md -->
---
description: "Build a source-derived writing style profile from real posts, essays, launch notes, docs, or site copy, then reuse that profile across content, outreach, and social workflows. Use when the user wants voice consistency without generic AI writing tropes."
category: "web"
namespace: "/web/brand-voice"
flat_command: "/brand-voice"
---

# Command: brand-voice (/web/brand-voice)

> **Trigger**: Build a source-derived writing style profile from real posts, essays, launch notes, docs, or site copy, then reuse that profile across content, outreach, and social workflows. Use when the user wants voice consistency without generic AI writing tropes.
> **Category**: Web & Frontend Development
> **Source Skill**: [skills/brand-voice/SKILL.md](file:///home/sanjeev/Downloads/agent-skills/skills/brand-voice/SKILL.md)
